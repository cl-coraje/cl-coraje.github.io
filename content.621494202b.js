// Public academic profile. Published metadata verified against Crossref; submitted paper verified on SSRN.
window.portfolioContent = {
  ...
  "papers": [
    {
      "year": "2026",
      "title": "Good Food? Coordinating Menu and Routing Operations on a Meal Delivery Platform",
      "authors": "Lei Cai; Saman Lagzi; Sheng Liu; Zhixing Luo",
      "status": "submitted",
      "links": [
        {
          "label": "投稿中 · SSRN",
          "labelEn": "Submitted · SSRN",
          "url": "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=7430080"
        }
      ]
    },
    {
  ...
  "socials": [
    ...
    },
    {
      ...
      "account": "MaxMin1995",
      "icon": "B",
      "url": "https://space.bilibili.com/3493082007865952"
    },
    {
      "name": "X",
      "account": "Donald John Cai",
      "handle": "@Donald_John_Cai",
      "icon": "𝕏",
      "url": "https://x.com/Donald_John_Cai"
    },
    {
      "name": "小红书",
      "nameEn": "Xiaohongshu",
    ...
    },
    {
      ...
      "account": "AI & OR",
      "icon": "↗",
      "url": "https://caileiphd.blogspot.com/"
    }
  ]
};
...
window.portfolioContentEn = {
  ...
  papers: window.portfolioContent.papers.map(paper => ({
    ...paper,
    links: paper.links.map(link => ({ ...link, label: link.labelEn || link.label }))
  })),
  socials: window.portfolioContent.socials.map(social => ({ ...social, name: social.nameEn || social.name }))
};
window.portfolioUI = {
  "zh": {
    "skip": "跳至主要内容",
